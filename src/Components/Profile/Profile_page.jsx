...
import { Edit, History, LinkOutlined } from '@mui/icons-material';
...
<NavLink to={'booking'} className=' text-decoration-none text-secondary fs-5 a2 fw-bold' ><div >My Bookings</div></NavLink>
<NavLink to={'history'} className=' text-decoration-none text-secondary fs-5 a2 fw-bold'>
    <div ><History className='fa-2xl'/> History</div></NavLink>
{

 user.isAdmin==true && <NavLink className=' text-decoration-none fs-5 text-danger a2 fw-bold'><div >My Hotels</div></NavLink>
}
